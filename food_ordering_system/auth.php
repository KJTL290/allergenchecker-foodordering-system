...
if ($action == 'login') {
    ...
    $appType = $data['app'] ?? 'admin'; // 'kiosk', 'operations' or 'admin'
...
if ($action == 'check_session') {
    ...
    elseif ($appType === 'operations' && isset($_SESSION['ops_session'])) {
        echo json_encode(["status" => "logged_in", "role" => $_SESSION['ops_session']['role']]);
    }
...
if ($action == 'logout') {
    ...
    elseif ($appType === 'operations') unset($_SESSION['ops_session']);
